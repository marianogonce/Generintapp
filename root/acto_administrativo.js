...
function popularPlantillaActoAdmnistrativo() {
  axios
    ...
    .then(async (response) => {
      ...
      if (
        ...
        parrafoAntecedente = document.getElementById("perfeccionado");
        ...
        parrafoAntecedente.textContent =
          parrafoAntecedente.textContent +
          `Que, en efecto, producto del referido procedimiento de selección se perfeccionó la Orden de Compra N° ${vectorDeExpedientesSeleccionados[0]["GenerInt_source.pc_regularizador.numero_oc"][0]} en fecha ${vectorDeExpedientesSeleccionados[0].perfeccionamiento_oc[0]}.`;
      }
...
try {
  popularPlantillaActoAdmnistrativo();
} catch {
